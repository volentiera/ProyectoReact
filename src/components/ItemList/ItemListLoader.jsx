    ...
    <div className="grid grid-cols-6">
      ...
      {fakeItems.map((e) => {
        return (
          <div
            key={e.id}
            className="p-5 m-5 text-gray-700 bg-white rounded-xl shadow-lg border-solid border-2 border-gray-300"
          >
            <svg
            ...
            <div className="mb-4 bg-gray-200 rounded-full loader-item-text"></div>
            <div className="mb-4 bg-gray-200 rounded-full loader-item-text"></div>
            <button className="px-4 py-2 mt-4 font-bold text-white bg-gray-500 rounded-full hover:bg-gray-700"></button>
          </div>
        );
      })}
    </div>
